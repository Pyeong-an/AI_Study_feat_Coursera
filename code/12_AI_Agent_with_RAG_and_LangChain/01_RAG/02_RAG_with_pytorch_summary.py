...
# 긍정적인/부정적인 대답 예시
yes_responses = [
    "Yes, this song contains violent themes, including references to guns, killing, or physical aggression, and is not suitable for children. / \'네, 이 노래에는 총기, 살인, 신체적 공격에 대한 언급을 포함한 폭력적인 주제가 포함되어 있어 아이들에게 적합하지 않습니다.\'",
    "Yes, this song includes explicit lyrics or bad words that might be considered offensive or inappropriate for young audiences. / \'예, 이 노래에는 젊은 청중에게 불쾌하거나 부적절하다고 여겨질 수 있는 노골적인 가사나 나쁜 단어가 포함되어 있습니다.\'",
    "No, the overall content of this song is not suitable for children as it includes themes, language, and messages that are too mature or unsuitable for young listeners. / \'아니요, 이 노래의 전체적인 내용은 너무 성숙하거나 어린 청취자들에게 적합하지 않은 주제, 언어, 메시지를 포함하고 있기 때문에 어린이들에게 적합하지 않습니다.\'",
    "Yes, this song explicitly mentions weapons, such as guns and knives, which could be disturbing or inappropriate for children’s entertainment. / \'네, 이 노래는 아이들의 오락에 방해가 되거나 부적절할 수 있는 총과 칼과 같은 무기를 명시적으로 언급하고 있습니다.\'",
    "Yes, the messages conveyed in this song are positive and uplifting, promoting values like kindness, friendship, and positivity, beneficial for children. / \'네, 이 노래에서 전달되는 메시지는 긍정적이고 고양된 것으로, 친절, 우정, 긍정과 같은 가치를 촉진하여 아이들에게 유익합니다.\'",
    "Yes, this song includes sexual content and references to sexual behavior or suggestive language, which are inappropriate for a child-friendly environment. / \'예, 이 노래에는 아동 친화적인 환경에 부적절한 성적 내용과 성적 행동 또는 암시적 언어에 대한 언급이 포함되어 있습니다.\'",
    "Yes, this song offers significant educational value, including segments that teach the alphabet, basic math, and other learning content, making it both fun and educational for children. / \'네, 이 노래는 알파벳, 기초 수학 및 기타 학습 내용을 가르치는 부분을 포함하여 아이들에게 재미있고 교육적인 중요한 교육적 가치를 제공합니다.\'",
    "Yes, this song promotes emotional resilience and social skills, incorporating themes about overcoming challenges and building friendships, which are essential for children's development / \'네, 이 노래는 아이들의 발달에 필수적인 도전을 극복하고 우정을 쌓는 주제를 포함하여 정서적 회복력과 사회성을 증진시킵니다.\'"]
...
# 각 노래에 대해 QA 결과 출력
print("-----Bullet in the Head-----")
RAG_QA(embeddings_questions, embeddings_rage)
print("----------------------------")
print("-----Can You Tell Me How to Get to Sesame Street?-----")
RAG_QA(embeddings_questions, embeddings_sesame_street)
print("------------------------------------------------------")
print("-----Straight Outta Compton-----")
